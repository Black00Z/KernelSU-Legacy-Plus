...
import me.weishu.kernelsu.ui.screen.destinations.ModuleActionScreenDestination
...
fun ModuleScreen(navigator: DestinationsNavigator) {
    ...
    // Companion mode: root is granted by the official KernelSU manager.
    // Do not require this APK to be crowned as the KernelSU manager.
        ...
        when {
            hasMagisk -> {
                ...
                ModuleList(
                    ...
                    }, onActionModule = { id, name ->
                        navigator.navigate(ModuleActionScreenDestination(id, name))
                    })
            }
        }
    }
...
private fun ModuleList(
    ...
    onActionModule: (id: String, name: String) -> Unit,
) {
...
private fun ModuleItem(
    ...
    onAction: (ModuleViewModel.ModuleInfo) -> Unit,
) {
    ElevatedCard(
        ...
        Column(modifier = Modifier.clickable { onClick(module) }.padding(24.dp, 16.dp, 24.dp, 0.dp)) {
            ...
            Row(
                ...
                if (module.hasActionScript) {
                    TextButton(
                        enabled = isChecked && !module.update && !module.remove,
